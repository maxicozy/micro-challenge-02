...
# Try the first available external camera (usually index 1 or 2)
# or fallback to the first available camera
...
# Add this after your camera initialization and before the main while loop
fourcc = cv2.VideoWriter_fourcc(*'mp4v')  # Define the codec
output_path = 'output.mp4'  # Define the output file path
